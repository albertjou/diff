...
describe AuthenticationsController do
  ...
  let(:valid_attributes) { { "volunteer_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved authentication as @authentication" do
        ...
        post :create, {:authentication => { "volunteer_id" => "invalid value" }}, valid_session
        assigns(:authentication).should be_a_new(Authentication)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested authentication" do
        ...
        Authentication.any_instance.should_receive(:update_attributes).with({ "volunteer_id" => "1" })
        put :update, {:id => authentication.to_param, :authentication => { "volunteer_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the authentication as @authentication" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Authentication.any_instance.stub(:save).and_return(false)
        put :update, {:id => authentication.to_param, :authentication => { "volunteer_id" => "invalid value" }}, valid_session
        assigns(:authentication).should eq(authentication)
      end
